...
const classesConfiguration = {
	artificer: "spell-class-filter-for-5e.ClassArtificer",
	barbarian: "spell-class-filter-for-5e.ClassBarbarian",
	bard: "spell-class-filter-for-5e.ClassBard",
	cleric: "spell-class-filter-for-5e.ClassCleric",
	druid: "spell-class-filter-for-5e.ClassDruid",
	fighter: "spell-class-filter-for-5e.ClassFighter",
	monk: "spell-class-filter-for-5e.ClassMonk",
	paladin: "spell-class-filter-for-5e.ClassPaladin",
	ranger: "spell-class-filter-for-5e.ClassRanger",
	rogue: "spell-class-filter-for-5e.ClassRogue",
	sorcerer: "spell-class-filter-for-5e.ClassSorcerer",
	warlock: "spell-class-filter-for-5e.ClassWarlock",
	wizard: "spell-class-filter-for-5e.ClassWizard",
	custom: "spell-class-filter-for-5e.ClassCustom"
};
...
export async function applySpellClassFilterItemSheet(app, html, itemData) {
	...
	if (type == "spell") {
		...
		const spellClassForm = await renderTemplate(`modules/${CONSTANTS.MODULE_ID}/templates/spellClassForm.hbs`, {
	...
	if (type == "character") {
		...
		if (user_setting_filterSelect) {
			...
			const actorClassFilter = await renderTemplate(
				`modules/${CONSTANTS.MODULE_ID}/templates/actorClassFilter.hbs`,
				{
					SCF: classesConfigurationTmp,
					actor,
					flags: flags,
